...
class OutputView {
    ...
    fun printResult(ranks: Ranks, payment: Int) {
        println("당첨 통계")
        println("---------")
        println("3개 일치 (${Rank.FOURTH.prize}원)- ${ranks.ranks[Rank.FOURTH]?:0}개")
        println("4개 일치 (${Rank.THIRD.prize}원)- ${ranks.ranks[Rank.THIRD]?:0}개")
        println("5개 일치 (${Rank.SECOND.prize}원)- ${ranks.ranks[Rank.SECOND]?:0}개")
        println("6개 일치 (${Rank.FIRST.prize}원)- ${ranks.ranks[Rank.FIRST]?:0}개")
